...
export const Dashboard = () => {
    ...
    useEffect(()=>{
        axios.get(`http://${BACK_PATH}/user/count`)
            .then((res)=>{
                setUserCount(res.data)
            })
        axios.get(`http://${BACK_PATH}/usedCars/count`)
            .then((res)=>{
                setUsedCarCount(res.data)
            })
        axios.get(`http://${BACK_PATH}/user/findBrandCar`)
            .then((res)=>{
                console.log(res.data)
                setBrandCar(res.data)
            })
        axios.get(`http://${BACK_PATH}/user/findBrandUsedCar`)
            .then((res)=>{
