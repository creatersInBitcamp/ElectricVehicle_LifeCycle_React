        ...
        <div className="product-box product-wrap">
            ...
            <div className="product-detail  text-center">
                <div>
                    ...
                    <h4>{props.symbol}{props.product.price-(props.product.price*props.product.discount/100)}</h4>
                    {props.product.variants?
                                ...
                                <div className="col-lg-6  col-xs-12">
                                    <div className="quick-view-img">
                                        <img src={props.product.variants?
                                            image?image:props.product.variants[0].images
                                            :props.product.pictures[0]} alt="" className="img-fluid" />
                                    </div>
                                </div>
                                <div className="col-lg-6 rtl-text">
                                    <div className="product-right">
                                        <h2> {props.product.name} </h2>
                                        <h3>{props.symbol}{props.product.price-(props.product.price*props.product.discount/100)}
